  ...
  exports: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          description: "Your app. It renders normally — the overlay and step popover mount alongside it only while the tour is active.",
        },
      ],
    },
    {
      ...
      props: [
        ...
        },
        {
          name: "content",
          type: "React.ReactNode",
          description: "Popover body — text, or whatever you want to render — and the step's accessible description.",
        },
        {
          name: "side",
      ...
      props: [
        {
          ...
          description: "Starts at the first step with a live target. Does nothing when the tour is already recorded as completed unless `force` is set — and it is safe to pass straight to `onClick`, since a DOM event carries no `force`.",
        },
        {
          name: "stop",
          type: "() => void",
      ...
      props: [
        {
          ...
          description: "Viewport-space rect of the element to highlight — a `getBoundingClientRect()` result, or anything with those four numbers. Non-finite values are read as zero rather than thrown on.",
        },
        {
          name: "padding",
          type: "number",
...
export function TourLauncher() {
  ...
  // force ignores the completion record — the "replay the tour" affordance.
  return (
