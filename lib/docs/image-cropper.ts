    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          name: "area",
          type: "Area",
          description: "The area to clamp. Returns a rounded `{ x, y, width, height }` guaranteed to be inside the source and at least 1px on each axis — the same clamping `getCroppedImage` applies internally.",
        },
      ],
    },
  ],
